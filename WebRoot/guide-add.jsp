...
<title>添加指南 - H-ui.admin v3.0</title>
<meta name="keywords"
...
<body>
	...
	<form action="./guide/add" method="get"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({Date:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" id="datemin" class="input-text Wdate" autocomplete="off" name="guideTime">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				 <select  class="form-control" name="guideState"><option>--------状态--------</option><option value="0">默认-0</option><option value="1">弹窗-1</option>

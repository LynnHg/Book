...
<body>
	...
	<form action="./circle/add" method="get"
		class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>openid:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder = "发布者" autocomplete="off"
					name="openid">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>发布动态</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="circleText" cols="" rows="" class="textarea"
					placeholder="内容" onKeyUp="textarealength(this,100)"></textarea>
				<p class="textarea-numberbar">
					<em class="textarea-length">
				</p>
			</div>

...
<title>添加反馈意见 - H-ui.admin v3.0</title>
<meta name="keywords"
...
<body>
	...
	<form action="./feedback/add" method="get"
 ...
 <input type="text"
				...
				id="datemin" class="input-text Wdate"  autocomplete="off" name="feedbackTime">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" placeholder="输入用户id:(如：12)"  class="input-text" autocomplete="off"
					name="openid" onblur="isCardNo(this)">
			</div>
		</div>
		...
		<!-- <div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
		<input class="btn btn-primary radius" type="submit" id="index"
		action="member-feedback.jsp"  method="post"
					value="&nbsp;放弃提交&nbsp;">
			</div> -->
